...
PORTFOLIO_SIZE = 30
HOLDING_DAYS = 20
MAX_WEIGHT_PER_INDUSTRY = 0.25  # 适当放宽单一行业权重
...
def run_scaled_analysis():
    ...
    print("\n==========================================================================")
    print("【CONCENTRATED TOP-30 PORTFOLIO WIND-DOWN TIMING SUMMARY (2021-2026)】")
    print("==========================================================================")
    print(pd.DataFrame(full_metrics).to_markdown(index=False))
    print("\n")
    
    print("==========================================================================")
    print("【YEAR-BY-YEAR SIDE-BY-SIDE PERFORMANCE AND DRAWDOWN COMPARISON (TOP-30)】")
    print("==========================================================================")
